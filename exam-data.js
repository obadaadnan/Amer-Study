...
/* =========================================================================
   بنك أسئلة اختبار الدرس الثالث: تسجيل القيود المحاسبية
   الثقافة المالية — جيل 2009
   -------------------------------------------------------------------------
   Transcribed exactly from the teacher's PDF. ONE exam, 19 questions:
   Q1–14 from the first section (صفحة 28), Q15–19 from the "السؤال الثالث"
   section on صفحة 29 whose numbering restarts at 1 in print — continued
   here as 15–19, same convention already used for الثقافة المالية الدرس (2).
   Each section has its own answer table in the PDF; both were read
   separately and merged in order. Every key entry was also cross-checked
   against the highlighted choice on each question — all 19 agree.
   ========================================================================= */
const EXAM_QUESTIONS_FC_L3 = [
  {
    id: 1,
    text: 'القيد المحاسبي الذي يتضمن أكثر من حساب (مديــن أو دائن) هو:',
    choices: { a: 'القيد البسيط', b: 'القيد الافتتاحي', c: 'القيد المركب', d: 'القيد الاسمي' }
  },
  {
    id: 2,
    text: 'أحد الحسابات الآتية يُصنف بوصفه حسابًا اسميًا:',
    choices: { a: 'حقوق الملكية', b: 'حساب المدينين (العملاء)', c: 'الأصول', d: 'الإيرادات' }
  },
  {
    id: 3,
    text: 'من خصائص الحسابات الحقيقية:',
    choices: {
      a: 'الاستمرار من مدة محاسبية إلى أُخرى، وعدم الإقفال في نهاية السنة المالية',
      b: 'الإقفال في نهاية السنة المالية، وتحويل الأرصــدة إلى حسابات حقوق الملكية',
      c: 'تُغلق في نهاية السنة المالية، ولا تحمل الأرصــدة إلى المدة المالية',
      d: 'تظهر الحقوق المستحقة للشركة'
    }
  },
  {
    id: 4,
    text: 'إحدى الآتية تمثّل قيد مركّب يشمل فيه الطرف الدائن فقط على أكثر من حساب:',
    choices: {
      a: 'من حـ/ ....... <br> إلى حـ/ .......',
      b: 'من مذكورين <br> حـ/ ....... <br> حـ/ ....... <br> إلى حـ/ .......',
      c: 'من حـ/ ....... <br> إلى مذكورين <br> حـ/ ....... <br> حـ/ .......',
      d: 'من مذكورين <br> حـ/ ....... <br> حـ/ ....... <br> إلى مذكورين <br> حـ/ ....... <br> حـ/ .......'
    }
  },
  {
    id: 5,
    text: 'من الحسابات التي تُصنف على أساس أنها حساب حقيقي:',
    choices: { a: 'الالتزامات', b: 'الإيرادات', c: 'المدينون', d: 'المصروفات' }
  },
  {
    id: 6,
    text: 'حسابات تستمر من مدّة محاسبية إلى أُخرى ولا تغلق في نهاية السنة المالية:',
    choices: { a: 'الاسمية', b: 'الشخصية', c: 'الموردون', d: 'الحقيقية' }
  },
  {
    id: 7,
    text: 'حســابــات تُستخدم فــي قياس أداء المؤسسة المالي خلال مدة زمنية معينة:',
    choices: { a: 'الموردون', b: 'الموردون', c: 'الشخصية', d: 'الشخصية' }
  },
  {
    id: 8,
    text: 'مؤسسة الاتحاد حققت إيرادات بقيمة 8000 دينار، وأُودع المبلغ في البنك فإن القيد المحاسبي لهذه العملية المالية في دفتر اليومية لمؤسسة الاتحاد هو:',
    choices: {
      a: '8000 من حـ/ البنك <br> 8000 إلى حـ/ الإيرادات <br> (تحقيق إيراد وأُودع بالبنك)',
      b: '8000 من حـ/ الإيرادات <br> 8000 إلى حـ/ البنك',
      c: '8000 من حـ/ الصندوق <br> 8000 إلى حـ/ الالتزامات',
      d: '8000 من حـ/ الصندوق <br> 8000 إلى حـ/ مصروف خدمة <br> (دفع مصروف خدمات نقدًا)'
    }
  },
  {
    id: 9,
    text: 'بتاريخ 1 / 4 / 2026 أودعت شركة أحمد رأس مال قدره 100000 دينار في البنك، فإنّ القيد المحاسبي لهذه العملية المالية في دفتر اليومية لشركة أحمد هي:',
    choices: {
      a: '100000 من حـ/ الصندوق <br> 100000 إلى حـ/ رأس المال <br> (بداية النشاط)',
      b: '100000 من حـ/ الصندوق <br> 100000 إلى حـ/ الإيرادات <br> (بداية النشاط)',
      c: '100000 من حـ/ البنك <br> 100000 إلى حـ/ رأس المال <br> (بداية النشاط)',
      d: '100000 من حـ/ رأس المال <br> 100000 إلى حـ/ الصندوق <br> (بداية النشاط)'
    }
  },
  {
    id: 10,
    text: 'استأجرت شركة لاريس مكتبًا بمبلغ 15000 دينار، دفعت بموجب شيك، فإنّ القيد المحاسبي لهذه العملية المالية في دفتر اليومية لمؤسسة لاريس، هو:',
    choices: {
      a: '15000 من حـ/ مصروف إيجار <br> 15000 إلى حـ/ البنك',
      b: '15000 من حـ/ خدمات <br> 15000 إلى حـ/ البنك',
      c: '15000 من حـ/ مكتب <br> 15000 إلى حـ/ الصندوق',
      d: '15000 من حـ/ البنك <br> 15000 إلى حـ/ مصروف إيجار'
    }
  },
  {
    id: 11,
    text: 'باعت مؤسسة النور بضاعة لمؤسسة الوليد بقيمة 10000 دينار حيث قبضت نصف المبلغ نقدًا والباقي على الآجل، فإنّ القيد المحاسبي لهذه العملية المالية في دفتر اليومية لمؤسسة النور، هو:',
    choices: {
      a: '10000 من حـ/ الصندوق <br> 10000 إلى حـ/ المبيعات',
      b: '10000 من حـ/ المبيعات <br> 10000 إلى حـ/ الصندوق',
      c: '10000 من حـ/ المبيعات <br> إلى مذكورين',
      d: 'من مذكورين <br> 5000 حـ/ الصندوق <br> 5000 حـ/ مدينون (مؤسسة الوليد) <br> 10000 إلى حـ/ المبيعات'
    }
  },
  {
    id: 12,
    text: 'قبضت المؤسسة مبلغ 1000 دينار نقدًا لقاء الخدمات، فإنّ الطرف الدائن في القيد المحاسبي:',
    choices: { a: 'الصندوق', b: 'البنك', c: 'إيراد (خدمات)', d: 'المصاريف' }
  },
  {
    id: 13,
    text: 'عملت شركة علي دعاية وإعلانًا عن خدماتها بمبلغ 800 دينار، ودفعت بالآجل لشركة الروّاد للإعلان، فإنّ القيد المحاسبي لهذه العملية المالية في دفتر اليومية لشركة علي، هو:',
    choices: {
      a: '800 من حـ/ مصروف دعاية <br> 800 إلى حـ/ الصندوق',
      b: '800 من حـ/ مصروف دعاية <br> 800 إلى حـ/ مؤسسة الروّاد للإعلان (دائنون)',
      c: '800 من حـ/ مصروف دعاية <br> 800 إلى حـ/ البنك',
      d: '800 من حـ/ مؤسسة الروّاد للإعلان (دائنون) <br> 800 إلى حـ/ مصروف دعاية'
    }
  },
  {
    id: 14,
    text: 'قدَّمت شركة الوليد مكافأة لأحد الموظفين بقيمة 1000 دينار بشيك، فإنّ الطرف المدين في القيد المحاسبي، هو:',
    choices: { a: 'مصروف (مكافأة)', b: 'البنك', c: 'خدمات (مكافأة)', d: 'إيرادات' }
  },
  {
    id: 15,
    text: 'القيد المحاسبي الذي يتضمَّن حسابين فقط؛ أحدهما مدين والآخر دائن، هو:',
    choices: { a: 'القيد البسيط', b: 'القيد المركب', c: 'القيد الشخصي', d: 'القيد الاسمي' }
  },
  {
    id: 16,
    text: 'أحد الحسابات الآتية يُصنف بوصفه حسابًا حقيقيًا:',
    choices: { a: 'الرواتب', b: 'الصندوق', c: 'إيراد الخدمات', d: 'مصروف الكهرباء' }
  },
  {
    id: 17,
    text: 'من خصائص الحسابات الاسمية:',
    choices: {
      a: 'الإقفال في نهاية السنة المالية، وتحويل الأرصدة إلى حسابات حقوق الملكية',
      b: 'الاستمرار من مُدَة محاسبية إلى أُخرى، وعدم الإقفال في نهاية السنة المالية',
      c: 'تمثيل الأصول والالتزامات المستمرة للمؤسسة',
      d: 'قياس الوضع المالي على المدى الطويل'
    }
  },
  {
    id: 18,
    text: 'عند تسجيل قيد مُركَّب، فإنَّ الحالة التي تنطبق على القيد هي:',
    choices: {
      a: 'تضمين القيد حسابًا مدينًا واحدًا، وحسابًا دائنًا واحدًا',
      b: 'اقتصار القيد على طرف واحد؛ إمّا مدين، وإمّا دائن',
      c: 'وجوب توقيع المُحاسِب فقط على القيد',
      d: 'تضمين القيد حسابات مُتعدِدة؛ سواءً في الطرف المدين، أو في الطرف الدائن'
    }
  },
  {
    id: 19,
    text: 'من الحسابات التي تُصنَف على أساس أنها حسابٌ اسمي:',
    choices: { a: 'حسابات القروض', b: 'المصروفات العامة', c: 'الأصول الثابتة', d: 'براءات الاختراع' }
  }
];

// Answer key from the two answer tables in the PDF (أ=a, ب=b, ج=c, د=d).
const EXAM_ANSWER_KEY_FC_L3 = {
  1: 'c', 2: 'd', 3: 'a', 4: 'c', 5: 'a', 6: 'd', 7: 'b', 8: 'a', 9: 'c', 10: 'a',
  11: 'd', 12: 'c', 13: 'b', 14: 'a', 15: 'a', 16: 'b', 17: 'a', 18: 'd', 19: 'b'
};

/* =========================================================================
   بنك أسئلة امتحان الدرس الثاني: نظريتا الباقي والعوامل
   الرياضيات — جيل 2010
   -------------------------------------------------------------------------
   Transcribed exactly from the teacher's PDF (نموذج مقترح، 27 فقرة).
   No graphs/figures in this exam (Q26 has a decorative truck clipart only,
   not needed to answer — deliberately not reproduced as it carries no
   mathematical information).

   IMPORTANT: the uploaded PDF contains NO answer table for this exam.
   The key below was computed by solving each question, and every entry
   still needs the teacher's confirmation before students rely on it.
   See the notes handed over with this update.
   ========================================================================= */
const EXAM_QUESTIONS_MATH_2010_L2 = [
  {
    id: 1,
    text: 'ناتج قسمة : \\(9x^3 - x + 3\\) على \\((3x - 2)\\) يساوي :',
    choices: {
      a: 'ناتج القسمة : \\(3x^2 + 2x + 1\\) والباقي \\(5\\)',
      b: 'ناتج القسمة : \\(2x^2 + 3x + 1\\) والباقي \\(5\\)',
      c: 'ناتج القسمة : \\(3x^2 + 2x + 1\\) والباقي \\(-5\\)',
      d: 'ناتج القسمة : \\(3x^2 + 2x - 1\\) والباقي \\(-5\\)'
    }
  },
  {
    id: 2,
    text: 'ناتج قسمة : \\((3x^4 + x^3 - 9x^2 - 8x + 9)\\) على \\((x - 2)\\) يساوى :',
    choices: {
      a: '\\(3x^2 + 7x^2 + 5x + 2 + \\frac{13}{x-2}\\)',
      b: '\\(3x^3 + 7x^2 + 5x + 2 + \\frac{13}{x-2}\\)',
      c: '\\(3x^3 + 7x^2 + 5x + 2 - \\frac{13}{x-2}\\)',
      d: '\\(3x^3 + 17x^2 + 5x + 2 + \\frac{13}{x-2}\\)'
    }
  },
  {
    id: 3,
    text: 'ناتج قسمة : \\((6x^3 - 7x^2 + 6x + 45)\\) على \\((2x + 3)\\) يساوى :',
    choices: { a: '\\(-1\\)', b: '\\(1\\)', c: '\\(0\\)', d: '\\(-2\\)' }
  },
  {
    id: 4,
    text: 'ناتج قسمة : \\(f(x) = x^3 - 2x^2 - 5x + 9\\) على \\((x + 2)\\) يساوى :',
    choices: { a: '\\(3\\)', b: '\\(9\\)', c: '\\(-1\\)', d: '\\(27\\)' }
  },
  {
    id: 5,
    text: 'باقي قسمة : \\(2x^3 - 7x^2 + 5\\) على \\((x - 3)\\) يساوي :',
    choices: { a: '\\(4\\)', b: '\\(-4\\)', c: '\\(2\\)', d: '\\(-2\\)' }
  },
  {
    id: 6,
    text: 'استعمل نظرية الباقي لإيجاد باقي قسمة : \\(P(x) = 2x^3 - 4x^2 - 2x + 1\\) على \\(h(x) = 2x - 1\\) :',
    choices: { a: '\\(-\\frac{3}{4}\\)', b: '\\(\\frac{3}{4}\\)', c: '\\(\\frac{4}{3}\\)', d: '\\(-\\frac{4}{3}\\)' }
  },
  {
    id: 7,
    text: 'أي الآتيه تعد عامل من عوامل : \\(P(x) = x^3 + 6x^2 + 5x - 12\\) :',
    choices: { a: '\\(x - 2\\)', b: '\\(x + 1\\)', c: '\\(x - 4\\)', d: '\\(x + 4\\)' }
  },
  {
    id: 8,
    text: 'أي الآتيه تعد تحليلاً كاملاً لــــــــ : \\(P(x) = x^3 - 2x^2 - 13x - 10\\) ، إذا علمت أن \\((x - 5)\\) عامل في عوامل \\(P(x)\\) :',
    choices: {
      a: '\\((x + 1)(x - 2)(x + 5)\\)',
      b: '\\((x - 1)(x + 2)(x - 5)\\)',
      c: '\\((x - 1)(x + 2)(x - 5)\\)',
  ...
  {
    id: 9,
    text: 'إذا كان \\((x + 4)\\) عاملاً من عوامل : \\(g(x) = x^3 + 2x^2 + px - 12\\) ، فإنّ قيمة \\(p\\) هي :',
    choices: { a: '\\(-1\\)', b: '\\(10\\)', c: '\\(11\\)', d: '\\(-11\\)' }
  },
  {
    id: 10,
    text: 'إذا كان باقي قســمة كثير الحدود : \\(f(x)\\) على \\((x - 1)\\) هو \\(2\\) وباقي قســمته على \\((x - 2)\\) هو \\(5\\) ، فإنّ باقي قســمة \\(f(x)\\) على \\((x - 1)(x - 2)\\) هو :',
    choices: { a: '\\(10\\)', b: '\\(1 - x\\)', c: '\\(2x - 1\\)', d: '\\(3x - 1\\)' }
  },
  {
    id: 11,
    text: 'إذا كان باقي قسـمة كثير الحدود : \\(f(x)\\) على \\((x - 1)\\) هو \\(3\\) وباقي قسـمته على \\((x - 3)\\) هو \\(1\\) ، فإنّ باقي قسـمته على \\((x - 1)(-3)\\) هو :',
    choices: { a: '\\(4 - x\\)', b: '\\(4 + x\\)', c: '\\(-4 - x\\)', d: '\\(x - 4\\)' }
  },
  {
    id: 12,
    text: 'إذا كان \\((x - 3)\\) عاملاً فى عوامل : \\(g(x) = 2x^3 + x^2 + px - 6\\) ، فإنّ قيمة \\(p\\) هو :',
    choices: { a: '\\(-17\\)', b: '\\(-3\\)', c: '\\(-19\\)', d: '\\(10\\)' }
  },
  {
    id: 13,
    text: 'إذا كان باقي قسمة : \\(f(x) = 2x^3 - x^2 + ax + 6\\) على \\(h(x) = x + 2\\) يساوى \\((-4)\\) ، فما قيمة \\(a\\) ؟',
    choices: { a: '\\(5\\)', b: '\\(-5\\)', c: '\\(3\\)', d: '\\(-3\\)' }
  },
  {
    id: 14,
    text: 'أي الخيارات الآتية تُعد تحليلاً كاملاً للأقتران الآتي : \\(g(x) = 3x^3 - 18x^2 + 2x - 12\\) :',
    choices: {
      a: '\\((x + 3)(3x^2 + 2)\\)', b: '\\((x + 6)(3x^2 + 2)\\)',
      c: '\\((x - 6)(3x^2 + 2)\\)', d: '\\((x - 3)(3x^2 + 2)\\)'
    }
  },
  {
    id: 15,
    text: 'أي الخيارات الآتية تمثّل جميع أصفار كثير الحدود : \\(P(x) = x^3 - 3x + 12\\) :',
    choices: {
      a: '\\(x = \\{1 , -2\\}\\)', b: '\\(x = \\{1 , 2\\}\\)',
      c: '\\(x = \\{2\\}\\)', d: '\\(x = \\{-1 , 2\\}\\)'
    }
  ...
  {
    id: 16,
    text: 'أي الخيارات الآتية تمثّل جميع أصفار كثير الحدود : \\(x^3 - x^2 - 9x + 9\\) :',
    choices: {
      a: '\\(\\{1 , 3\\}\\)', b: '\\(\\{-1 , 3\\}\\)',
      c: '\\(\\{1 , -3 , 3\\}\\)', d: '\\(\\{-1 , 3 , -3\\}\\)'
    }
  ...
  {
    id: 17,
    text: 'حل المعادلة الآتية : \\(x^3 + 3x^2 = 13x + 15\\) هو :',
    choices: {
      a: '\\(x = \\{-5 , -3 , 1\\}\\)', b: '\\(x = \\{-5 , 3 , -1\\}\\)',
      c: '\\(x = \\{-5 , 3 , 1\\}\\)', d: '\\(x = \\{5 , -3 , -1\\}\\)'
    }
  ...
  {
    id: 18,
    text: 'حل المعادلة الآتية : \\(2x^3 + 5x^2 - 16x - 36 = 0\\) هو :',
    choices: {
      a: '\\(x = \\{-2 , \\frac{-1 \\pm \\sqrt{145}}{4}\\}\\)',
      b: '\\(x = \\{-2 , \\frac{1 \\pm \\sqrt{145}}{4}\\}\\)',
      c: '\\(x = \\{-2 , \\frac{1 \\pm \\sqrt{154}}{4}\\}\\)',
      d: '\\(x = \\{2 , \\frac{-1 \\pm \\sqrt{145}}{4}\\}\\)'
    }
  },
  {
    id: 19,
    text: 'إذا كان : \\(f(x) = x^3 - 3x + 2\\) ، فإنّ عدد الأصفار النسبية المحتملة للاقتران \\(f(x)\\) يساوي :',
    choices: { a: '\\(4\\)', b: '\\(2\\)', c: '\\(3\\)', d: '\\(8\\)' }
  },
  {
    id: 20,
    text: 'إذا كان : \\(f(x) = 3x^3 + 14x^2 - 7x - 10\\) ، فإنّ عدد الأصفار النسبية المحتملة للاقتران \\(f(x)\\) يساوي :',
    choices: { a: '\\(8\\)', b: '\\(14\\)', c: '\\(12\\)', d: '\\(16\\)' }
  },
  {
    id: 21,
    text: 'إذا كان \\(x = -1\\) حلاً للمعادلة : \\(x^3 + 3x^2 = 13x + 15\\) فإنّ لها حلّين آخرين هما :',
    choices: {
      a: '\\(x = 3 , x = 5\\)', b: '\\(x = -3 , x = -5\\)',
      c: '\\(x = -3 , x = 5\\)', d: '\\(x = 3 , x = -5\\)'
    }
  ...
  {
    id: 22,
    text: 'إذا كان \\(x = -3\\) حلاً للمعادلة : \\(2x^3 + x^2 = 13x - 6\\) فإنّ لها حلّين آخرين هما:',
    choices: {
      a: '\\(x = \\frac{1}{2} , x = -2\\)', b: '\\(x = -\\frac{1}{2} , x = 2\\)',
      c: '\\(x = \\frac{1}{2} , x = 2\\)', d: '\\(x = -\\frac{1}{2} , x = -2\\)'
    }
  },
  {
    id: 23,
    text: 'إذا كان : \\(f(x) = x^4 + 3x^3 + px - 32\\) ، وكان باقي قســمة \\(f(x)\\) على \\((x - 1)\\) مســاوياً لباقي قســمة على \\((x + 2)\\) ، فإنّ قيمة الثابت \\(p\\) هي :',
    choices: { a: '\\(-12\\)', b: '\\(-4\\)', c: '\\(4\\)', d: '\\(12\\)' }
  },
  {
    id: 24,
    text: 'إذا كان باقي قسمة \\(f(x) = x^3 + ax^2 + x + 5\\) على \\((x - 1)\\) ، يسـاوي مثلثي باقي قسـمته على \\((x + 1)\\) ، فما قيمة \\(a\\) ؟',
    choices: { a: '\\(a = -1\\)', b: '\\(a = 2\\)', c: '\\(a = 1\\)', d: '\\(a = -2\\)' }
  },
  {
    id: 25,
    text: 'إذا كان باقي قســمة : \\(f(x) = ax^3 + bx^2 + bx + 3\\) على : \\(h(x) = x - 1\\) يســاوي \\((4)\\) وكان \\((x + 1)\\) عاملاً فى العوامل \\(f(x)\\) ، فما قيمة كل من \\(a\\) ، \\(b\\) ؟',
    choices: {
      a: '\\(a = 3 \\ , \\ b = -1\\)', b: '\\(a = -3 , \\ b = 1\\)',
      c: '\\(a = -3 , \\ b = -1\\)', d: '\\(a = 3 \\ , \\ b = 1\\)'
    }
  ...
  {
    id: 26,
    text: 'صندوق شاحنة على شكل متوازي مستطيلات، أبعاده بالأمتار : \\(2 , x , x^2 + 6x - 19\\) ما قيمة \\(x\\) التي تجعل حجم الصندوق \\(48m^3\\) :',
    choices: { a: '\\(3m\\)', b: '\\(6m\\)', c: '\\(9m\\)', d: '\\(12m\\)' }
  },
  {
    id: 27,
    text: 'إذا كان باقي قسمة كثير الحدود \\(f(x)\\) على \\((x - 3)\\) يسـاوي \\(4\\) ، وباقي قسمته على \\((x + 2)\\) يسـاوي \\(9\\) ، فأوجد باقي قسمته \\(f(x)\\) على \\((x - 3)(x + 2)\\):',
    choices: { a: '\\(-x + 7\\)', b: '\\(x - 7\\)', c: '\\(-x - 7\\)', d: '\\(x + 7\\)' }
  }
];

// COMPUTED key — the PDF for this exam contains no answer table.
// Needs the teacher's confirmation before use.
const EXAM_ANSWER_KEY_MATH_2010_L2 = {
  1: 'a', 2: 'b', 3: 'c', 4: 'a', 5: 'b', 6: 'a', 7: 'd', 8: 'd', 9: 'd', 10: 'd',
  11: 'a', 12: 'c', 13: 'b', 14: 'c', 15: 'a', 16: 'c', 17: 'b', 18: 'a', 19: 'a',
  20: 'd', 21: 'd', 22: 'c', 23: 'b', 24: 'a', 25: 'a', 26: 'a', 27: 'a'
};
...
const EXAM_REGISTRY = {
  ...
  'fc-l3': {
    subject: 'الثقافة المالية',
    unit: 'الوحدة (1) الدورة المحاسبية في المؤسسات الخدمية',
    examName: 'الدرس (3): تسجيل القيود المحاسبية',
    questions: EXAM_QUESTIONS_FC_L3,
    answerKey: EXAM_ANSWER_KEY_FC_L3,
    labels: { a: 'أ', b: 'ب', c: 'ج', d: 'د' },
    models: {
      'النموذج الأول': { from: 1, to: 19 }
    }
  ...
  'math2010-l2': {
    ...
    examName: 'الدرس (2): نظريتا الباقي والعوامل',
    questions: EXAM_QUESTIONS_MATH_2010_L2,
    answerKey: EXAM_ANSWER_KEY_MATH_2010_L2,
    models: {
      'النموذج الأول': { from: 1, to: 27 }
    }
  },
