  ...
  '2010-math': [
    {
      ...
      items: [
        ...
        { title: 'الدرس (3): نظريتا الباقي والعوامل', type: 'exam', examId: 'math2010-l2' },
  ...
  '2009-financial-culture': [
    {
      ...
      items: [
        ...
        { title: 'الدرس (2): نظرية القيد المزدوج والعمليات المالية', type: 'exam', examId: 'fin-culture-l2' },
        { title: 'الدرس (3): تسجيل القيود المحاسبية', type: 'exam', examId: 'fc-l3' },
